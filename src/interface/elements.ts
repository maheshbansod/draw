...
class ElementStore {
  ...
  drawSelectedLineSegmentSetOutline() {
    ...
    const outlineSegmentSet = new LineSegmentSet(
      this.selectedLineSegmentSet.getSegments(),
      "cyan",
      1,
      this.selectedLineSegmentSet.loop
    );
  ...
  addCircle(
    ...
    const segmentSet = new LineSegmentSet(lines, strokeStyle, lineWidth, true);
    this.lineSegmentSets.push(segmentSet);
    return segmentSet;
  }
